...
const navItems = [
  ...
  { id: 'audit-scanner', label: 'Audit Scanner', icon: ShieldCheck, path: '/scanner' },
  { id: 'storage', label: 'Storage Inspector', icon: HardDrive, path: '/storage' },
  { id: 'integrity', label: 'Integrity Scorer', icon: ShieldAlert, path: '/integrity' },
