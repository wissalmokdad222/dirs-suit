    ...
    <div className="fade-in">
      <header className="mb-12 border-b border-beige-dark pb-8">
        <div className="flex justify-between items-end">
          ...
          <Link to="/apk-analyzer" className="btn-primary flex items-center gap-2">
            <ShieldCheck size={20} />
            Scanner un APK
          </Link>
        </div>
      ...
      <div className="grid grid-cols-1 gap-8 mb-12">
        <div className="card p-12 bg-primary/5 border border-primary/20 flex items-center gap-10 group hover:bg-primary/10 transition-all">
          <div className="p-6 bg-primary text-white rounded-3xl shadow-xl shadow-primary/30 group-hover:scale-110 transition-transform">
            <ShieldCheck size={48} />
          </div>
          <div>
            <h3 className="text-3xl font-serif font-bold mb-2">APK Security Scanner</h3>
            <p className="text-lg text-text-secondary">Vérifiez l'intégrité et les permissions de n'importe quel fichier APK en un clic.</p>
            <Link to="/scanner" className="btn-primary inline-flex items-center gap-2 mt-6">
              Lancer l'Analyse APK <ChevronRight size={18} />
            </Link>
          </div>
        </div>
      </div>
